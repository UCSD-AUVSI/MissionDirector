...
def main(argv):
	...
	if len(argv) < 1:
		print("usage:  {ip-address-for-listen}  {optional:use-insecure-comms?}  {optional:ssl-certs-folder}")
		quit()
	...
	sslcertsfolder = ""
	if len(argv) >= 3:
		sslcertsfolder = argv[2]
		print("SSL certs will be loaded from \'"+sslcertsfolder+"\'")
